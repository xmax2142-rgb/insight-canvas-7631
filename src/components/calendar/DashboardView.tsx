      ...
      <ScrollArea className="flex-1">
        <div className="space-y-6 pb-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <Card className="bg-card/50 border-border/30 backdrop-blur-sm cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:border-primary/50" onClick={() => handleCardClick({ categories: ["meetings", "audits", "compliance", "training"], statuses: ["planned", "confirmed", "completed", "postponed"], priorities: ["high", "medium", "low"] })}><CardContent className="p-4"><div className="flex items-center justify-between"><div><p className="text-sm text-muted-foreground">Total Events</p><p className="text-3xl font-bold text-foreground">{totalEvents}</p></div><div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center"><Calendar className="h-6 w-6 text-primary" /></div></div></CardContent></Card>
            <Card className="bg-card/50 border-border/30 backdrop-blur-sm cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:border-primary/50" onClick={() => { handleCardClick({}); }}><CardContent className="p-4"><div className="flex items-center justify-between"><div><p className="text-sm text-muted-foreground">Today</p><p className="text-3xl font-bold text-foreground">{todayEvents.length}</p></div><div className="w-12 h-12 rounded-xl bg-blue-500/10 flex items-center justify-center"><Clock className="h-6 w-6 text-blue-500" /></div></div></CardContent></Card>
            <Card className="bg-card/50 border-border/30 backdrop-blur-sm cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:border-status-completed/50" onClick={() => handleCardClick({ statuses: ["completed"] })}><CardContent className="p-4"><div className="flex items-center justify-between"><div><p className="text-sm text-muted-foreground">Completed</p><p className="text-3xl font-bold text-foreground">{completedEvents}</p></div><div className="w-12 h-12 rounded-xl bg-status-completed/10 flex items-center justify-center"><CheckCircle2 className="h-6 w-6 text-status-completed" /></div></div></CardContent></Card>
            <Card className="bg-card/50 border-border/30 backdrop-blur-sm cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:border-status-overdue/50" onClick={() => handleCardClick({ statuses: ["planned", "confirmed", "postponed"] })}><CardContent className="p-4"><div className="flex items-center justify-between"><div><p className="text-sm text-muted-foreground">Overdue</p><p className="text-3xl font-bold text-status-overdue">{overdueEvents.length}</p></div><div className="w-12 h-12 rounded-xl bg-status-overdue/10 flex items-center justify-center"><AlertTriangle className="h-6 w-6 text-status-overdue" /></div></div></CardContent></Card>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            <Card className="bg-card/50 border-border/30 backdrop-blur-sm cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:border-primary/50" onClick={() => handleCardClick({ statuses: ["completed"] })}><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><TrendingUp className="h-4 w-4" />Completion Rate</CardTitle></CardHeader><CardContent><div className="space-y-3"><div className="flex items-end justify-between"><span className="text-4xl font-bold text-foreground">{completionRate}%</span><span className="text-sm text-muted-foreground">{completedEvents}/{totalEvents}</span></div><Progress value={completionRate} className="h-2" /></div></CardContent></Card>
            <Card className="bg-card/50 border-border/30 backdrop-blur-sm cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:border-priority-high/50" onClick={() => handleCardClick({ priorities: ["high"], statuses: ["planned", "confirmed", "postponed"] })}><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><Flame className="h-4 w-4 text-priority-high" />High Priority</CardTitle></CardHeader><CardContent><div className="flex items-end justify-between"><span className="text-4xl font-bold text-priority-high">{highPriorityEvents.length}</span><span className="text-sm text-muted-foreground">pending</span></div></CardContent></Card>
            <Card className="bg-card/50 border-border/30 backdrop-blur-sm cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:border-primary/50" onClick={() => handleCardClick({ statuses: ["planned", "confirmed", "postponed"] })}><CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><BarChart3 className="h-4 w-4" />This Week</CardTitle></CardHeader><CardContent><div className="flex items-end justify-between"><span className="text-4xl font-bold text-foreground">{thisWeekEvents.length}</span><span className="text-sm text-muted-foreground">upcoming</span></div></CardContent></Card>
          </div>
          ...
          <Card className="bg-card/50 border-border/30 backdrop-blur-sm"><CardHeader><CardTitle className="text-sm font-medium text-muted-foreground flex items-center gap-2"><Users className="h-4 w-4" />By Status</CardTitle></CardHeader><CardContent><div className="grid grid-cols-2 lg:grid-cols-4 gap-4">{eventsByStatus.map(({ status, count, label, color }) => (<div key={status} onClick={() => handleCardClick({ statuses: [status] })} className={cn("text-center p-4 rounded-xl bg-secondary/30 cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] hover:bg-secondary/60")}><p className={cn("text-3xl font-bold", color)}>{count}</p><p className="text-sm text-muted-foreground mt-1">{label}</p></div>))}</div></CardContent></Card>
        </div>
      </ScrollArea>
    </div>
  );
