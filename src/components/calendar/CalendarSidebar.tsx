...
export function CalendarSidebar({ filters, onFiltersChange, onClose, isMobile }: CalendarSidebarProps) {
  ...
  return (
    <div className={cn("flex flex-col h-full", isMobile ? "p-4 bg-card" : "p-5 border-r border-border/30 bg-card/50")}>
      <div className="flex items-center justify-between mb-6"><div className="flex items-center gap-3"><div className="p-2.5 rounded-xl bg-primary/20"><Filter className="h-4 w-4 text-primary" /></div><h2 className="font-bold text-lg text-foreground">Filters</h2></div></div>
